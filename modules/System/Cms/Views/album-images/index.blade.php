...
<form action="index" method="POST" id="frmAlbumImagesIndex">
    <input type="hidden" name="_token" value="{{ csrf_token() }}">
    <section class="content-wrapper">
        <ol class="breadcrumb" >
            <li><a role="button" onclick="LoadModul('{{ url("system/album-images") }}', 'list');"><i class="fa fa-list"></i> Quản trị album</a></li>
        </ol>
            ...
            <div class="panel-body">
                ...
                <div class="row form-group input-group-index">
                    <div class="pull-right">
                        <button class="btn btn-basic " id="btn_manager_album" type="button" data-toggle="tooltip"  data-original-title="Quản trị ảnh"><i class="fa fa-cogs"></i> Quản trị ảnh</button>
                ...
                <div class="row" id="table-container">
                    <table class="table table-striped table-bordered dataTable no-footer" align="center" id="table-data">
                        ...
                        <tbody id="data-list-album-images">
...
<div class="modal fade" id="FileOnServerModal" role="dialog">
</div>
<script type="text/javascript">
    var baseUrl = '{{ url("") }}';
    var JS_AlbumImages = new JS_AlbumImages(baseUrl, 'system/cms', 'album-images');
    jQuery(document).ready(function($) {
    JS_AlbumImages.loadIndex();
    })
</script>
<style>
    #table-mo-ta tr td{

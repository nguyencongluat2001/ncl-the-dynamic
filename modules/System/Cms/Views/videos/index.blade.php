...
<form action="index" method="POST" id="frmVideosIndex">
    <input type="hidden" name="_token" value="{{ csrf_token() }}">
    <section class="content-wrapper">
        <ol class="breadcrumb" >
            <li><a role="button" onclick="LoadModul('{{ url("system/videos") }}', 'list');"><i class="fa fa-list"></i>Quản trị video</a></li>
        </ol>
...
<script type="text/javascript">
    var baseUrl = '{{ url("") }}';
    var JS_Videos = new JS_Videos(baseUrl, 'system/cms', 'videos');

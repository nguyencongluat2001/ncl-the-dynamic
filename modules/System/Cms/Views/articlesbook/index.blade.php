...
<form action="index" method="POST" id="frmArticlesBookIndex">
    <input type="hidden" name="_token" value="{{ csrf_token() }}">
    <section class="content-wrapper">
        <ol class="breadcrumb" >
            <li><a><i class="fa fa-list"></i> Quản trị bài viết giới thiệu sách</a></li>
        </ol>
...
<!-- Hien thi modal -->
<div class="modal-content" id="modalArticlesBook">
</div>
<div class="modal fade"  role="dialog" id="modalDialog">
</div>
<script type="text/javascript">
    var baseUrl = '{{ url("") }}';
    var JS_ArticlesBook = new JS_ArticlesBook(baseUrl, 'system/cms', 'articlesbook');
    jQuery(document).ready(function($) {
    JS_ArticlesBook.loadIndex();
    });

                ...
                <div class="modal-body">
                    ...
                    {{-- Tên đợt --}}
                        <div class="form-group col-md-6" data-form="add">
                            <div class="row">
                                <label align="right" class="radio ms-0 col-md-4 text-right control-label required">Tên đợt</label>
                                <div class="col-md-8">
                        ...
                        <div class="form-group col-md-6" data-form="add">
                            <div class="row">
                                <label align="right" class="radio ms-0 col-md-4 text-right control-label required">Hội thi năm</label>
                                <div class="col-md-8">
                        ...
                        <div class="form-group col-md-6" data-form="add">
                            <div class="row">
                                <label align="right" class="radio ms-0 col-md-4 text-right control-label required">Ngày bắt đầu</label>
                                <div class="col-md-8">
                        ...
                        <div class="form-group col-md-6" data-form="add">
                            <div class="row">
                                <label align="right" class="radio ms-0 col-md-4 text-right control-label required">Ngày kết thúc</label>
                                <div class="col-md-8">
                        ...
                        <div class="form-group col-md-6" data-form="add">
                            <div class="row">
                                <label align="right" class="radio ms-0 col-md-4 text-right control-label required">Thời gian làm bài</label>
                                <div class="col-md-8">
                        ...
                        <div class="form-group col-md-6" data-form="add">
                            <div class="row">
                                <label align="right" class="radio ms-0 col-md-4 text-right control-label required">Trạng thái</label>
                                <div class="col-md-8">

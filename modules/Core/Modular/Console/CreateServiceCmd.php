...
class CreateServiceCmd extends Command
{
     ...
     * @var string
     */
    protected $signature = 'create:service {path} {--packet=Api} {--module=default}';
    ...
    public function handle()
    {
        ...
        if($packet == "Api"){
            ...
            $stubs = __DIR__.'/stubs/api/service.stub';
            $className = explode('@', $this->argument('path'))[0];
            if($adminFolder == 'default'){
                $this->adminFolder = "";
                $filePath = $modulePath."/Services/".$className."Service.php";
            }else if($adminFolder == 'Admin'){
                $this->adminFolder = "\Admin";
                $filePath = $modulePath."/Services/Admin/".$className."Service.php";
            }else{
            ...
            $stubs = __DIR__.'/stubs/service.stub';

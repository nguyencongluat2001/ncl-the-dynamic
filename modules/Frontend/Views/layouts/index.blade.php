...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('/resources/vendors/nice-select/nice-select.css') }}">
  ...
  <!--================ Start Header Menu Area =================-->
    ...
    <div class="main_menu">
      <nav class="navbar navbar-expand-lg navbar-light">
        <div class="container">
          <a class="navbar-brand logo_h" href="index.html"><img src="{{ asset('/resources/img/logo.png')}}" alt=""></a>

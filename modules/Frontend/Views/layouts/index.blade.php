...
<head>
    ...
    <title>HỆ THỐNG TRẢ KẾT QUẢ</title>
    ...
    <link rel="stylesheet" href="../css/assets/toastr.min.css">
    ...
    <script type="text/javascript" src="{{ URL::asset('assets\js\toastr.min.js') }}"></script>

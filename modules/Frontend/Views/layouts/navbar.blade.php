<nav class="navbar navbar-expand-lg" style="font-family: serif;background:#37a956">
    <div style="width:60%;display:flex">
        <div>
            <a class="nav-link" href=""><img href="" class="card-img "
                    src="../img/favicon.ico" alt="Card image"></a>
        </div>
        <div>
            <div class="title-index" style="padding-top: 16px;font-size: 20px;color: white;font-weight: 600;">KHOA CHẨN ĐOÁN HÌNH ẢNH</div>
        </div>
    </div>

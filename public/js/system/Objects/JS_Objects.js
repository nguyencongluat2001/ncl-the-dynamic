function JS_Objects(baseUrl, module, action) {
    this.module = module;
...
JS_Objects.prototype.loadIndex = function () {
    console.log(222)
    ...
    $(oForm).find('#search_text').keypress(function (e) {
     ...
     // form load
     $(oForm).find('#ngay_bat_dau').change(function() {
        myClass.loadList(oForm);
    });
    // form load
    $(oForm).find('#ngay_ket_thuc').change(function() {
        myClass.loadList(oForm);
    });
     // form load
...
JS_Objects.prototype.loadevent = function (oForm) {
    $('.chzn-select').chosen({ height: '100%', width: '100%' });
    var myClass = this;
...
JS_Objects.prototype.loadList = function (oForm, currentPage = 1, perPage = 15) {
    var oForm = 'form#frmlist_index';
    var myClass = this;
...
// Them loai danh muc
JS_Objects.prototype.add = function (oForm) {
 ...
 * @return void
 */
JS_Objects.prototype.store = function (oFormCreate) {
...
// sua
JS_Objects.prototype.edit = function (oForm) {
...
// Xoa mot doi tuong
JS_Objects.prototype.delete = function (oForm) {
...
JS_Objects.prototype.show = function (id) {
...
// sua
JS_Objects.prototype.question = function (id) {
 ...
 * @return void
 */
JS_Objects.prototype.getUnit = function (type) {
    var myClass = this;
    ...
    $.ajax({
        ...
        success: function (arrResult) {
            var html = `<div id="unit">`
                html += `<select onchange="JS_Objects.loadList()" class="form-select form-select-md" id="don_vi" name="don_vi">`

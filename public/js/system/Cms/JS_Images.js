function JS_Images(baseUrl, module, action) {
    // check side bar
//    $("#main_cms").attr("class", "active");
    $("#main_images").attr("class", "active");
    this.module = module;
...
JS_Images.prototype.loadIndex = function () {
    var myClass = this;
...
JS_Images.prototype.loadevent = function (oForm) {
    var myClass = this;
...
JS_Images.prototype.loadList = function (oForm, currentPage = 1, perPage = 15) {
...
JS_Images.prototype.genTable = function (arrResult) {
    var shtml = '';
    ...
    for (var x in arrResult) {
        ...
        shtml += '<tr>';
        shtml += '<td align="center"><input type="checkbox" ondblclick="" onclick="{select_checkbox_row(this);}" name="chk_item_id" value="' + arrResult[x]['PK_CMS_IMAGEADVERTISE'] + '"></td>';
...
JS_Images.prototype.genTableMota = function (arrResult) {
    ...
    shtml += '</tr>';
    shtml += '<tr>';
    shtml += '<td align="right">Địa chỉ liên kết</td>';
    shtml += '<td>' + arrResult['C_URL'] + '</td>';
    shtml += '</tr>';
    shtml += '<tr>';
...
// Them loai danh muc
JS_Images.prototype.add = function (oForm) {
...
JS_Images.prototype.backtoindex = function () {
    $('#modalImages').html('');
    $('#frmImagesIndex').show();
    $('#modalImages').hide();
}
JS_Images.prototype.validateform = function (oForm) {
...
// sua
JS_Images.prototype.edit = function (oForm) {
...
// Them loai danh muc
JS_Images.prototype.delete = function (oForm) {
...
JS_Images.prototype.preview_images = function () {
    $('#image_onserver').val('');
    var myClass = this;
    ...
    if (extensionFile == 'jpg' || extensionFile == 'png') {
        $('#image_preview').html("<div class='col-md-3'><img class='img-responsive' src='" + URL.createObjectURL(event.target.files[0]) + "'></div>");
        if (myClass.formdata) {
...
JS_Images.prototype.PreviewFeatureImage = function ()
{
    var myClass = this;
...
JS_Images.prototype.update = function (oForm) {
    if (oForm.valid()) {
...
JS_Images.prototype.getextensionfile = function (filename) {
    return(/[.]/.exec(filename)) ? /[^.]+$/.exec(filename) : undefined;
}
JS_Images.prototype.deletefile = function (obj, a) {
    $('#file' + a).remove();
    this.formdata.delete("file" + a);
    $('#images').val('');
}
JS_Images.prototype.preview_images_onserver = function () {
    var myClass = this;
...
JS_Images.prototype.selectImage = function (url) {
...
JS_Images.prototype.selectFolder = function (path) {
    var myClass = this;

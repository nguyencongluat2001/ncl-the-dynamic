			...
			if (!this._initialized) {
				...
				if (!styled) {
					...
					styles = [
						...
						'.jstree-table-header-regular {position:relative; background-color: #F9F9F9; z-index: 1;text-align: center;}',
						...
						'.jstree-table-midwrapper a.jstree-clicked, .jstree-table-midwrapper a.jstree-hovered{}',

function JS_Product(baseUrl, module, controller) {
    this.module = module;
 ...
 * @return void
 */
JS_Product.prototype.loadIndex = function () {
    var myClass = this;
...
JS_Product.prototype.loadevent = function (oForm) {
    var myClass = this;
    $('form#frmAddCategory').find('#btn_create').click(function () {
        myClass.store('form#frmAddCategory');
    })
 ...
 * @return void
 */
JS_Product.prototype.add = function (oForm) {
 ...
 * @return void
 */
JS_Product.prototype.store = function (oFormCreate) {
 ...
 * @return void
 */
JS_Product.prototype.loadList = function (oForm = '#frmProduct_index', numberPage = 1, perPage = 15) {
    var myClass = this;
 ...
 * @return void
 */
JS_Product.prototype.edit = function (id) {
...
// Xoa mot doi tuong
JS_Product.prototype.delete = function (oForm) {
    var myClass = this;
    var listitem = '';
 ...
 */
JS_Product.prototype.addrow = function() {
    ...
    html += '<span class="custom-control-indicator p-0 m-0" onclick="JS_Product.changeStatusCategoryCate(\'' + id + '\')"></span>';
    html += '</label></td>';
    // edit
    html += '<td align="center"><span class="text-cursor text-warning" onclick="JS_Product.edit(\''+id+'\')"><i class="fas fa-edit"></i></span></td>';
    html += '</tr>';
...
function click2(id, type) {
    ...
    $("#"+type+"_" + id).focusout(function(){
        ...
        if(text != $(".span_" + type + '_' + id).html()){
            JS_Product.updateCategoryCate(id, type, $(".span_" + type + '_' + id).html());
        }
    })
}
/**
 ...
 */
JS_Product.prototype.updateCategoryCate = function(id, column, value = '') {
    var myClass = this;
 ...
 * Thay đổi trạng thái
 */
JS_Product.prototype.changeStatusCategoryCate = function(id){
    var myClass = this;

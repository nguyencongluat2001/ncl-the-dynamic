function EfyLib(options = null) { }

EfyLib.prototype.loadding = function () {
    var loadding = new Nanobar();
    return loadding;
}

EfyLib.prototype.showmainloadding = function () {
    $("#loading").show();
}

EfyLib.prototype.successLoadImage = function () {
    // $("#loadding").hide();
    $("#loading").hide();
    $(".search").button('reset');
}
...
EfyLib.prototype.loadModul = function (url, Module, SubModul = '') {
    data = '';
    $.ajax({
        url: url,
        type: "GET",
...
EfyLib.prototype.swalAlert = function (nameMessage, icon, color, background) {
    Swal.fire({
        position: 'top-start',
        icon: icon,
        title: nameMessage,
 ...
 * @param {*} s 
 */
EfyLib.prototype.alertMessage = function (type, label, message, s = 2000) {
    var vclass = 'alert';
    lclass = 'fas ';
    if (type == 'success') {
...
// Hien thi loadding
EfyLib.prototype.showLoadList = function () { }

EfyLib.prototype.showLoadSearch = function () {
    $('.search').button('loading');
}

EfyLib.prototype.showLoadMain = function () {
    $(".main_loadding").show();
}

EfyLib.prototype.successLoad = function () {
    simplebar.go(100);
}

EfyLib.prototype.cbDateRange = function (start, end) {
    $('input[name="daterange"]').html(start.format('MMMM D, YYYY') + ' - ' + end.format('MMMM D, YYYY'));
}

EfyLib.prototype.createDateRange = function (obj) {
...
EfyLib.prototype.loadFileJsCss = function (arrUrl) {
    // Load file Js va Css
...
EfyLib.prototype.changepassword = function (v_this) {
    var myClass = this;
...
EfyLib.prototype.daterangepicker = function (obj) {
    var currentTime = new Date();
    var lastyear = currentTime.getFullYear() - 1;
...
EfyLib.prototype._save_xml_tag_and_value_list = function (oForm) {
    var myclass = this;
...
EfyLib.prototype._get_value_xml_by_type = function (type, obj) {
    var value = '';
    if (type == 'checkbox') {
        if (obj.is(':checked')) {
            value = 'HOAT_DONG';
    ...
    if (strrsearch) {
        ...
        $.ajax({
            ...
            error: function (arrResult) {
                EfyLib.successLoadImage();
                EfyLib.alertMessage('danger', "Không tìm thấy kết quả, vui lòng xem lại!");
            }
        });
    } else {
        EfyLib.alertMessage('danger', "Bạn chưa nhập từ khóa cần tìm");
        return false;
    }
}
